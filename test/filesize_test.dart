...
void main() {
  group('filesize', () {
    ...
    test('returns MB for megabyte range', () {
      expect(filesize(1048576), '1 MB');
      expect(filesize(2097152), '2 MB');
      expect(filesize(1572864), '2 MB');
      expect(filesize(1500000), '1.43 MB');
    });

    test('returns GB for gigabyte range', () {
      expect(filesize(1073741824), '1 GB');
      expect(filesize(2147483648), '2 GB');
    });

    test('respects custom round parameter', () {
      expect(filesize(1536, 1), '1.5 KB');
      expect(filesize(1536, 0), '2 KB');
      expect(filesize(1536, 3), '1.500 KB');
    });
  });
}
